...
const CancelScheduledMessageRequest = testerlib.CancelScheduledMessageRequest;
const SendMessagesResponse = testerlib.SendMessagesResponse;
const SendMessagesRequest = testerlib.SendMessagesRequest;
...
describe("MessagesController Tests", function tests() {
     ...
     */
    it("should testSendMessages1 response", function testSendMessages1Test(done) {
        // parameters for the API call
        let body = baseController.getObjectMapper().mapObject({ "messages": [ { "callback_url": "https://my.callback.url.com", "content": "My first message", "destination_number": "+61491570156", "delivery_report": true, "format": "SMS", "message_expiry_timestamp": "2016-11-03T11:49:02.807Z", "metadata": { "key1": "value1", "key2": "value2" }, "scheduled": "2016-11-03T11:49:02.807Z", "source_number": "+61491570157", "source_number_type": "INTERNATIONAL" }, { "callback_url": "https://my.callback.url.com", "content": "My second message", "destination_number": "+61491570158", "delivery_report": true, "format": "SMS", "message_expiry_timestamp": "2016-11-03T11:49:02.807Z", "metadata": { "key1": "value1", "key2": "value2" }, "scheduled": "2016-11-03T11:49:02.807Z", "source_number": "+61491570159", "source_number_type": "INTERNATIONAL" } ]}, 'SendMessagesRequest');

        controller.createSendMessages(body, function callback(error, response, context) {
            // test response code
    ...
    */
    it("should testSendMessagesWithInvalidAccountTest response", function testSendMessagesWithInvalidAccountTest(done) {
        // parameters for the API call
        let body = baseController.getObjectMapper().mapObject({ "messages": [ { "callback_url": "https://my.callback.url.com", "content": "My first message", "destination_number": "+61491570156", "delivery_report": true, "format": "SMS", "message_expiry_timestamp": "2016-11-03T11:49:02.807Z", "metadata": { "key1": "value1", "key2": "value2" }, "scheduled": "2016-11-03T11:49:02.807Z", "source_number": "+61491570157", "source_number_type": "INTERNATIONAL" }, { "callback_url": "https://my.callback.url.com", "content": "My second message", "destination_number": "+61491570158", "delivery_report": true, "format": "SMS", "message_expiry_timestamp": "2016-11-03T11:49:02.807Z", "metadata": { "key1": "value1", "key2": "value2" }, "scheduled": "2016-11-03T11:49:02.807Z", "source_number": "+61491570159", "source_number_type": "INTERNATIONAL" } ]}, 'SendMessagesRequest');

        controller.createSendMessages(body, function callback(error, response, context) {}, "INVALID ACCOUNT")
          .catch((error) => {
