...
const controller = testerlib.RepliesController;
const ConfirmRepliesAsReceivedRequest = testerlib.ConfirmRepliesAsReceivedRequest;
const CheckRepliesResponse = testerlib.CheckRepliesResponse;

describe("RepliesController Tests", function tests() {
     ...
     */
    it("should testConfirmRepliesAsReceived1 response", function testConfirmRepliesAsReceived1Test(done) {
        // parameters for the API call
        let body = baseController.getObjectMapper().mapObject({"reply_ids":["011dcead-6988-4ad6-a1c7-6b6c68ea628d","3487b3fa-6586-4979-a233-2d1b095c7718","ba28e94b-c83d-4759-98e7-ff9c7edb87a1"]}, 'ConfirmRepliesAsReceivedRequest');

        controller.createConfirmRepliesAsReceived(body, function callback(error, response, context) {
            // test response code
    ...
    */
    it("should testConfirmRepliesAsReceivedWithInvalidAccountTest response", function testConfirmRepliesAsReceivedWithInvalidAccountTest(done) {
        // parameters for the API call
        let body = baseController.getObjectMapper().mapObject({"reply_ids":["011dcead-6988-4ad6-a1c7-6b6c68ea628d","3487b3fa-6586-4979-a233-2d1b095c7718","ba28e94b-c83d-4759-98e7-ff9c7edb87a1"]}, 'ConfirmRepliesAsReceivedRequest');

        controller.createConfirmRepliesAsReceived(body, function callback(error, response, context) {}, "INVALID ACCOUNT")
          .catch((error) => {
     ...
     */
   it("should testCheckReplies1 response", function testCheckReplies1Test(done) {
        controller.getCheckReplies(function callback(error, response, context) {
            // test response code
            ...
            assert.isTrue(context.response.body.startsWith('{"replies"'));
            done();
        });
    });
    ...
    * Make sure our SDK fails when passed an invalid account id
    */
    it("should testCheckRepliesWithInvalidAccountTest response", function testCheckRepliesWithInvalidAccountTest(done) {
        controller.getCheckReplies(function callback(error, response, context) {}, "INVALID ACCOUNT")
          .catch((error) => {
            assert.equal(403, error.errorCode);
            done();
        })
