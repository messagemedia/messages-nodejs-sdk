...
class RepliesController {
     ...
     * @returns {Promise}
     */
    static createConfirmRepliesAsReceived(body, callback, accountHeaderValue) {
        _logger.info('createConfirmRepliesAsReceived being called');
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;

        const _requestUrl = '/v1/replies/confirmed';
        ...
        return new Promise((_fulfill, _reject) => {
            ...
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    if(_response.body != null && _response.body != undefined && _response.body != '')
                    {
                        parsed = JSON.parse(_response.body);
                    }
     ...
     * @returns {Promise}
     */
    static getCheckReplies(callback, accountHeaderValue) {
        _logger.info('getCheckReplies being called');
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;

        const _requestUrl = '/v1/replies';
