...
class DeliveryReportsController {
     ...
     * @returns {Promise}
     */
    static getCheckDeliveryReports(callback, accountHeaderValue) {
        _logger.info('getCheckDeliveryReports being called');
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;

        const _requestUrl = '/v1/delivery_reports';
     ...
     * @returns {Promise}
     */
    static createConfirmDeliveryReportsAsReceived(body, callback, accountHeaderValue) {
